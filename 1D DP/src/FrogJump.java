public class FrogJump {
    ...
    public static void main(String[] args) {
        System.out.println(rec(5,new int[]{30,10,60,10,60,50}));
        System.out.println(memo(5,new int[]{30,10,60,10,60,50},new int[]{-1,-1,-1,-1,-1,-1}));
        System.out.println(tabu(5,new int[]{30,10,60,10,60,50}));
    }
